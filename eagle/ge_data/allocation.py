...
for i in range(num_p):
    ...
    command = "python eagle/ge_data/ge_data_all_llama3instruct.py --start={} --end={} --index={} --gpu_index {} --outdir {} --data_path {}".format(start, end, index, gpu_index_str, outdir, args.data_path)
